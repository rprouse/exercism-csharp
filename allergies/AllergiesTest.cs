...
public class AllergiesTest
{
    ...
    {
        var allergies = new Allergies(1);
        Assert.Equal(allergies.List(),new List<string> { "eggs" });
    }
    ...
    public void Allergic_to_just_peanuts()
    {
        ...
        Assert.Equal(allergies.List(),new List<string> { "peanuts" });
    }
    ...
    public void Allergic_to_eggs_and_peanuts()
    {
        ...
        Assert.Equal(allergies.List(),new List<string> { "eggs", "peanuts" });
    }
    ...
    public void Allergic_to_lots_of_stuff()
    {
        ...
        Assert.Equal(allergies.List(),
           new List<string> { "strawberries", "tomatoes", "chocolate", "pollen", "cats" });
    }
