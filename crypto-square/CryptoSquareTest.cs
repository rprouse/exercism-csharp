...
public class CryptoSquareTest
{
    ...
    public void Segments_are_split_by_square_size()
    {
        ...
        Assert.Equal(crypto.PlaintextSegments(), new[] { "neverv", "exthin", "eheart", "withid", "lewoes" });
    }
    ...
    public void Segments_are_split_by_square_size_until_text_runs_out()
    {
        ...
        Assert.Equal(crypto.PlaintextSegments(), new[] { "zomg", "zomb", "ies" });
    }
    ...
    public void Normalized_ciphertext_not_exactly_divisible_by_5_spills_into_a_smaller_segment()
    {
        ...
        Assert.Equal("msemo aanin dninn dlaet ltshu i", crypto.NormalizeCiphertext());
    }
    ...
    public void Normalized_ciphertext_is_split_into_segements_of_correct_size()
    {
        ...
        Assert.Equal("imtgdvs fearwer mayoogo anouuio ntnnlvt wttddes aohghns seoau", crypto.NormalizeCiphertext());
    }
